...
public interface CACTListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterFuncFParam(CACTParser.FuncFParamContext ctx);
	/**
	 * Exit a parse tree produced by {@link CACTParser#funcFParam}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link CACTParser#unaryOp}.
	 * @param ctx the parse tree
	 */
	void enterUnaryOp(CACTParser.UnaryOpContext ctx);
	/**
	 * Exit a parse tree produced by {@link CACTParser#unaryOp}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link CACTParser#mulOp}.
	 * @param ctx the parse tree
	 */
	void enterMulOp(CACTParser.MulOpContext ctx);
	/**
	 * Exit a parse tree produced by {@link CACTParser#mulOp}.
	 * @param ctx the parse tree
	 */
	void exitMulOp(CACTParser.MulOpContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CACTParser#addOp}.
	 * @param ctx the parse tree
	 */
	void enterAddOp(CACTParser.AddOpContext ctx);
	/**
	 * Exit a parse tree produced by {@link CACTParser#addOp}.
	 * @param ctx the parse tree
	 */
	void exitAddOp(CACTParser.AddOpContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CACTParser#relOp}.
	 * @param ctx the parse tree
	 */
	void enterRelOp(CACTParser.RelOpContext ctx);
	/**
	 * Exit a parse tree produced by {@link CACTParser#relOp}.
	 * @param ctx the parse tree
	 */
	void exitRelOp(CACTParser.RelOpContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CACTParser#eqOp}.
	 * @param ctx the parse tree
	 */
	void enterEqOp(CACTParser.EqOpContext ctx);
	/**
	 * Exit a parse tree produced by {@link CACTParser#eqOp}.
	 * @param ctx the parse tree
	 */
	void exitEqOp(CACTParser.EqOpContext ctx);
	/**
